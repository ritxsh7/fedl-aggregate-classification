...
# Load train data
client3_train = load_train_data()
client3_test = load_test_data()

count = client3_train['labels'].value_counts()

plotMap(count)

client3_train_gen = datagen.flow_from_dataframe(
    client3_train,
    x_col = "filepaths",
    y_col = "labels",
    target_size = (244,244),
...
client3_test_gen = datagen.flow_from_dataframe(
    client3_test,
    x_col = "filepaths",
    y_col = "labels",
    target_size = (244,244),
...
client = FlwrClient(model, client3_train_gen, client3_test_gen)
